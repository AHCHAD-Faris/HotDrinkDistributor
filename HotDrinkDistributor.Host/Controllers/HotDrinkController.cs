...
namespace HotDrinkDistributor.Host.Controllers
{
    ...
    public class HotDrinkController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public IActionResult GetRecipe(int id) => Ok(_hotDrinkService.GetRecipe(id));

        [HttpGet]
        public IActionResult GetAllRecipes() => Ok(_hotDrinkService.GetAllRecipes());

        [HttpPost]
        public IActionResult AddRecipe([FromBody] RecipeInfra recipe)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult UpdateRecipe([FromBody] RecipeInfra modifiedRecipe)
        {
            try
            {
